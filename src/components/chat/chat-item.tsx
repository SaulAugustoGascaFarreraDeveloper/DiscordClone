...
import { z } from "zod"
import { editFormSchema } from "@/app/schemas/formSchea"
...
const ChatItem = ({id,content,member,timestamp,fileUrl,deleted,currentMember,isUpdated,socketUrl,socketQuery}:ChatItemProps) => {
    ...
    const isVideo = fileType === "mp4" && fileUrl && !isPdf
    const isImage = !isPdf && !isVideo && fileType
        ...
        <div className="relative group flex items-center hover:bg-black/5 p-4 transition w-full">
                <div className="group flex gap-x-2 items-start w-full">
                    ...
                    <div className="flex flex-col w-full">
                        ...
                        {
                            !fileUrl && !isEditing && (
                                <p className={cn("text-zinc-600 dark:text-zinc-300 text-sm"
                                                ...
                                                <FormItem className="flex-1">
                                                    <FormControl>
                                                        <div className="relative w-full">
                                                            ...
                                                            dark:text-zinc-200" placeholder="Edited message" {...field} />
                                                        </div>
                                                    </FormControl>
                                                </FormItem>
                                            )}
                        ...
                        absolute p-1 -top-2 right-5 bg-white dark:bg-zinc-800 border rounded-sm">
                            {
                                canEditMessage && (
                                    <ActionTooltip label="Edit">
                                            <Edit onClick={() => setIsEditing(true)} className="cursor-pointer ml-auto w-4 h-4 text-zinc-500 
